...
export default function FomularioProductoEdit({ editarProducto, producto, textoBoton }) {
  let { register, handleSubmit,setValue, errors} = useForm();

  useEffect(()=>{
    let {producto_nombre, producto_descripcion, producto_precio, producto_stock} = producto;
